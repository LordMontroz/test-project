...
//3.	По клику изменяется количество товара. (изначально товар 1)
  components: {
    "counter-block": {
      data: function data() {
        return {
      ...
      template:
        '<div class="stepper">                <input class="product__count stepper-input" type="text" :value="counter" >                <span class="stepper-arrow up" v-on:click="increase"></span>                <span class="stepper-arrow down" v-on:click="decrease"></span>              </div>\n              ',
      methods: {
